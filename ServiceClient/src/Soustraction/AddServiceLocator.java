...
public class AddServiceLocator extends org.apache.axis.client.Service implements Soustraction.AddService {
    ...
    private java.lang.String Add_address = "http://localhost:8080/CalculeService/services/Add";
    ...
    public Soustraction.Add getAdd() throws javax.xml.rpc.ServiceException {
    ...
    public Soustraction.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Soustraction.AddSoapBindingStub _stub = new Soustraction.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Soustraction.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                Soustraction.AddSoapBindingStub _stub = new Soustraction.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Soustraction", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Soustraction", "Add"));
        }
