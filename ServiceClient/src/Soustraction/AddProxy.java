...
public class AddProxy implements Soustraction.Add {
  private String _endpoint = null;
  private Soustraction.Add add = null;
  ...
  private void _initAddProxy() {
    try {
      add = (new Soustraction.AddServiceLocator()).getAdd();
      if (add != null) {
        if (_endpoint != null)
  ...
  public Soustraction.Add getAdd() {
    if (add == null)
      _initAddProxy();
    return add;
  }
