...
public class AddServiceLocator extends org.apache.axis.client.Service implements Compare.AddService {
    ...
    public Compare.Add getAdd() throws javax.xml.rpc.ServiceException {
    ...
    public Compare.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Compare.AddSoapBindingStub _stub = new Compare.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Compare.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                Compare.AddSoapBindingStub _stub = new Compare.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Compare", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Compare", "Add"));
        }
