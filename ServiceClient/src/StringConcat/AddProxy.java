...
public class AddProxy implements StringConcat.Add {
  private String _endpoint = null;
  private StringConcat.Add add = null;
  ...
  private void _initAddProxy() {
    try {
      add = (new StringConcat.AddServiceLocator()).getAdd();
      if (add != null) {
        if (_endpoint != null)
  ...
  public StringConcat.Add getAdd() {
    if (add == null)
      _initAddProxy();
    return add;
  }
