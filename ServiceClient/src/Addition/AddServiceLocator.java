...
public class AddServiceLocator extends org.apache.axis.client.Service implements Addition.AddService {
    ...
    public Addition.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Addition.AddSoapBindingStub _stub = new Addition.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Addition.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                Addition.AddSoapBindingStub _stub = new Addition.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Addition", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Addition", "Add"));
        }
