...
public class AddServiceLocator extends org.apache.axis.client.Service implements Equals.AddService {
    ...
    public Equals.Add getAdd() throws javax.xml.rpc.ServiceException {
    ...
    public Equals.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Equals.AddSoapBindingStub _stub = new Equals.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Equals.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                Equals.AddSoapBindingStub _stub = new Equals.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Equals", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Equals", "Add"));
        }
